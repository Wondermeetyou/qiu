...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://localhost:3306/qiu?useUnicode=true&characterEncoding=utf-8&userSSL=false&serverTimezone=GMT%2B8";
    // 数据库驱动
    ...
    // @author 值
    private static final String AUTHOR = "qiu";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.qiu";
    // xml文件路径
